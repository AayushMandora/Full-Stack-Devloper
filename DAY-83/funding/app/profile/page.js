    ...
    <div className="font-semibold text-xl text-center">Welcome to Your Profile</div>
      <div className="w-[50vw]">
        <form class="max-w-md mx-auto">
          ...
          <button
            type="submit"
            class="text-white hover:bg-blue-800 focus:ring-4 focus:outline-none text-sm w-full px-5 py-2.5 text-center p-2 rounded-lg bg-gradient-to-br from-blue-600 to-purple-700 font-bold"
          >
            Save
          </button>
        </form>
